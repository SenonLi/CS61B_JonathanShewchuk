...
public class SList {
  ...
  public static void main (String[] args) {
    ...
    SList lstTest = new SList();
    lstTest.insertEnd(new Integer(6));
    lstTest.insertEnd(new Integer(9));
    lstTest.insertEnd(new Integer(12));
	    System.out.println("Here is a list after construction: "
		       + lstTest.toString());
    TestHelper.verify(lstTest.toString().equals("[  6  9  12  ]"),
		      "toString with [ 6 9 12 ] failed");
    lstTest.insertFront(new Integer(3));
    lstTest.insertEnd(new Integer(15));
    System.out.println("Here is a list after changing: "
		       + lstTest.toString());
   TestHelper.verify(lstTest.toString().equals("[  3  6  9  12  15  ]"),
		      "toString with [  3  6  9  12  15  ] failed");
    testEmpty();
